...
/* ESM default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Smooth);
    ...
    _create_class(App, [
        {
            ...
            value: function createAjaxNavigation() {
                var easeIn = function(container, done) {
                    return gsap__WEBPACK_IMPORTED_MODULE_8__["default"].to(container, {
                        autoAlpha: 0,
                        duration: 1,
                        ease: 'none',
                        onComplete: function() {
                ...
                var easeOut = function(container) {
                    return gsap__WEBPACK_IMPORTED_MODULE_8__["default"].from(container, {
                        autoAlpha: 0,
                        duration: 1,
                        ease: 'none'
                    });
